--[[ * qr plugin uses: * - http://goqr.me/api/doc/create-qr-code/ * psykomantis ]] local function get_hex(str)
  local colors = {
    red = "f00",
    blue = "00f",
    green = "0f0",
  ...
  return str end local function qr(receiver, text, color, bgcolor)
  ...
  return "Oops! Something strange happened :(" end local function run(msg, matches)
  ...
  return qr(receiver, text, color, back) end return {
